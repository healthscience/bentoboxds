<template>
  ...
  >
    ...
    <div v-show="height > 80 || storeAI.activeLifeStrapID || storeBesearch.showBesearchDetail" class="bottom-panel-content" ref="contentArea">
      ...
      <div ref="lensSection" class="lens-section" >
        <div v-if="isLensCollapsed === true" class="lens-collapsed-bar" @click="expandLens">
...
watch(() => storeAI.activeLifeStrapID, (newVal) => {
...
watch(() => storeBesearch.showBesearchDetail, (newVal) => {
