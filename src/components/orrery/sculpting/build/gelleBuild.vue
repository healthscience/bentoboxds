<template>
  <div class="authoring-workspace">
    ...
    <div class="author-form">
      ...
      <div class="form-section">
        <label>Parent gelle ID</label>
        <input v-model="newSeed.concept.anchors.parentgelleId" type="text" placeholder="e.g., root_torso_01" />
      </div>
      ...
      <div class="form-section">
        ...
        <input v-model="newSeed.computational.instanceId" type="text" placeholder="e.g., gelle_inst_left_arm_88x" />
      </div>
