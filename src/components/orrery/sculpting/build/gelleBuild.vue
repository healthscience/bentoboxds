  ...
  <div class="gelle-contract-author">
    ...
    <div class="author-form">
      ...
      <div id="computation-contract-file">
        <div class="form-group-header">add gelle computation file</div>
...
<style scoped>
.gelle-contract-author { width: 90%; padding: 15px; border: 4px solid #ccc; border-radius: 8px; }
